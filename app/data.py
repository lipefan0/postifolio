...
skills = [
    {'icon': 'img/icon/python.png', 'skill': 'Python', 'link': 'https://www.python.org/'},
    {'icon': 'img/icon/flask.png', 'skill': 'Flask', 'link': 'https://flask.palletsprojects.com/'},
    {'icon': 'img/icon/sql.png', 'skill': 'SQL', 'link': 'https://www.w3schools.com/sql/'},
...
projects = [
    ...
    {'name': 'Projeto 2', 'github': 'https://github.com/seu_usuario/projeto2', 'image': 'img/project-2.png'},
